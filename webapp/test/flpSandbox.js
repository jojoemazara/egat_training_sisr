		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comegattrainingzuserinfosisr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comegattrainingzuserinfosisr-display": {
								"semanticObject": "comegattrainingzuserinfosisr",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.egat.training.zuserinfosisri",
									"url": sap.ui.require.toUrl("com.egat.training.zuserinfosisri")
								}
							}
						}
					}
